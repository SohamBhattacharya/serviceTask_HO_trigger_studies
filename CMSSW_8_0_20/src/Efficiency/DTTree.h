...
// Fri Apr 28 16:31:53 2017 by ROOT version 6.06/01
// from TTree DTTree/CMSSW DT tree
// found on file: /eos/cms/store/group/dpg_dt/comm_dt/dtRootple2016/Express/DTTree_Run285371.root
//////////////////////////////////////////////////////////
...
#ifdef DTTree_cxx
DTTree::DTTree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/dpg_dt/comm_dt/dtRootple2016/Express/DTTree_Run285371.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/dpg_dt/comm_dt/dtRootple2016/Express/DTTree_Run285371.root");
      }
...
Int_t DTTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DTTree::LoadTree(Long64_t entry)
{
...
void DTTree::Show(Long64_t entry)
{
...
Int_t DTTree::Cut(Long64_t entry)
{
