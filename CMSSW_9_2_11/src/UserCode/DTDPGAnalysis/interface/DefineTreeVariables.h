...
std::vector<int> ltTwinMux_thPosition;
std::vector<int> ltTwinMux_thQuality;
std::vector<int> ltTwinMux_thIeta;

//muon variables
std::vector<short> STAMu_isMuGlobal;
std::vector<short> STAMu_isMuTracker;
std::vector<short> STAMu_isMuLoose;
std::vector<short> STAMu_isMuMedium;
...
std::vector<float> Mu_phiMB1_mu;
std::vector<float> Mu_etaMB1_mu;
std::vector<float> Mu_phiMB2_mu;
std::vector<float> Mu_etaMB2_mu;
