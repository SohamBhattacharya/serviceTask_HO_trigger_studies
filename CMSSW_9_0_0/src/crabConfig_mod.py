...
#inputDataset = "/ZeroBiasBunchTrains0/Run2016H-v1/RAW"
inputDataset = "/ZeroBiasBunchTrains5/Run2016H-v1/RAW"
jobName = inputDataset[inputDataset.find("/", 0)+1: inputDataset.find("/", 1)] # + "_withCode7"
cmsRunFileName = "EDAnalyzers/RatePlot_myVersion/python/ConfFile_cfg.py"
