...
void L1TwinMuxAlgorithm::run(edm::Handle<L1MuDTChambPhContainer> inphiDigis,
    ...
    const edm::EventSetup& c)
{
            ...
            hoTP != hotpHandle->end(); ++hoTP)
    {
        ...
        printf("TwinMuxAlgo: %d %d %d \n", hoTP->ieta(), hoTP->iphi(), isMip);
    }
    ...
    HOTwinMuxAlgorithm::addHOinfo( \
        &l1ttma_out, \
        thetaDigis->getContainer(), \
        hotpHandle);
